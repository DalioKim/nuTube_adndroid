...
import com.example.youtube.GoCoderSDKPrefs;
import com.example.youtube.DataTableFragment;
import com.example.youtube.MultiStateButton;
import com.example.youtube.StatusView;
import com.example.youtube.TimerView;
import com.example.youtube.VolumeChangeObserver;
...
public class WatchingLiveActivity extends GoCoderSDKActivityBase implements WOWZPlayerStatusCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_watching_live);
...
//                    });
            ...
            mVolumeSettingChangeObserver = new VolumeChangeObserver(WatchingLiveActivity.this, new Handler());
            ...
            mBufferingDialog = new ProgressDialog(WatchingLiveActivity.this);
            ...
            mGoingDownDialog = new ProgressDialog(WatchingLiveActivity.this);
...
//                    mStreamPlayerView.getCurrentStatus().waitForState(WOWZState.PLAYER_IDLE);
    ...
    public void playStream()
    {
        ...
        if (configValidationError != null) {
            ...
            float preBufferDuration = GoCoderSDKPrefs.getPreBufferDuration(PreferenceManager.getDefaultSharedPreferences(WatchingLiveActivity.this));

            mStreamPlayerConfig.setPreRollBufferDuration(preBufferDuration);
            // Start playback of the live stream
            mStreamPlayerView.play(mStreamPlayerConfig, WatchingLiveActivity.this);
        }
    }
            ...
            public void run() {
                switch (playerStatus.getState()) {
                    ...
                    case PLAYING:
                        ...
                        GoCoderSDKPrefs.storeHostConfig(PreferenceManager.getDefaultSharedPreferences(WatchingLiveActivity.this), mStreamPlayerConfig);
                        break;
